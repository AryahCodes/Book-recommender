...
#gradio is good for showcasing llm models and dashboards
...
def retrieve_sem_recommendations(query: str,
                                 category: str = None,
                                 tone: str= None,
...
def recommend_books(query: str,
                    category: str,
                    tone: str):
    recommendations = retrieve_sem_recommendations(query, category, tone)
    results = []
